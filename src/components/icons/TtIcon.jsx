// TikTok brand icon. Single source of truth — replaces 3 inline copies in
// AccountCard, AccountHealthGrid, and ProfileHeader. Use <TtIcon className="..." />
// the same way as Lucide's <Instagram className="..." />.
export function TtIcon({ className }) {
  return (
