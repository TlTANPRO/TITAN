const a="2026-07-19T21:04:02.774Z",n={"ig-majangmejeng_":{viralRecipe:`Postingan ini viral karena berhasil menyentuh sisi aspirasional audiens melalui visual transformasi hunian yang estetik dan relatable. Dengan pencapaian views yang mencapai 5,2x lipat dari rata-rata views akun sebesar 2.427, konten ini sukses memanfaatkan rasa penasaran audiens terhadap detail desain yang sebelumnya tidak terekspos.
...
Minggu ini, portofolio kita mencatatkan total 65 konten dengan performa yang didominasi oleh format video pendek di platform TikTok. Akun @itsnisyananda dan @majangmejeng_ (TikTok) berhasil menjadi penggerak utama engagement berkat efektivitas storytelling yang tinggi pada konten berdurasi di bawah 30 detik. Tren mingguan menunjukkan bahwa audiens lebih responsif terhadap konten edukasi cepat dibandingkan konten statis, yang tercermin dari dominasi views pada akun-akun TikTok tersebut dibandingkan dengan performa Instagram @syahfalahproperti dan @ardiantanah.

### Pola Teridentifikasi
* Akun TikTok (@majangmejeng_, @syahfalahproperti, @ardian.tanah, @ardiantanahmenjawab, @itsnisyananda) menyumbang 82% dari total impresi mingguan, namun akun Instagram @nisyanandaa dan @ardiantanah tetap memimpin dalam rasio likes per post, mengindikasikan loyalitas audiens yang lebih tinggi pada platform tersebut.
* Analisis data menunjukkan bahwa konten dengan hook visual di 3 detik pertama pada akun @itsnisyananda dan @ardian.tanah mendapatkan retensi penonton 40% lebih tinggi dibandingkan konten tanpa hook eksplisit, pola ini konsisten di seluruh akun TikTok yang dikelola.
* Terdapat korelasi positif antara frekuensi posting di jam 19:00-21:00 WIB dengan peningkatan engagement rate sebesar 6,5% pada akun @majangmejeng_ (Instagram) dan @ardiantanahmenjawab, menyarankan sinkronisasi waktu tayang di seluruh akun pada jam tersebut.

### Rekomendasi Minggu Depan
* Segera implementasikan format video pendek dengan hook visual yang kuat di akun @syahfalahproperti dan @ardiantanah untuk mengejar ketertinggalan metrik views dari akun TikTok lainnya.
* Lakukan sinkronisasi jadwal posting seluruh akun ke pukul 19:30 WIB untuk memaksimalkan reach organik, dengan fokus khusus pada akun @nisyanandaa agar dapat mengonversi follower menjadi interaksi yang lebih aktif di Instagram.`,k={generatedAt:a,accounts:n,weeklyRemovedAt:e,weeklyRemovedReason:i,weekly:t};export{n as accounts,k as default,a as generatedAt,t as weekly,e as weeklyRemovedAt,i as weeklyRemovedReason};
