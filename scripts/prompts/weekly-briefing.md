...
- Which account(s) drove the most engagement
...
- Cite the accounts or numbers involved
- Be specific (not "posting is good" but "3 dari 5 akun posting di 19:00-21:00 WIB mendapat ER >5%")

Examples:
- "Akun @X dan @Y sama-sama viral dengan Reel 30 detik, suggest format ini untuk diuji di akun Z"
- "Akun TikTok mendominasi views minggu ini (78% dari total views), tapi Instagram mendapat likes lebih tinggi per post"

### Section 3: 1-2 Rekomendasi Minggu Depan (Next-week recommendations)

1-2 short bullets. Each must:
- Be specific and actionable
- Reference which account(s) need attention
- Have a clear action (e.g. "Post Reel 30 detik di @X Senin jam 19:00")
...
- No preamble
- Cite at least 2 specific usernames or numbers
- No emojis
